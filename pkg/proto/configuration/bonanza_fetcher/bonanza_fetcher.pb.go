...
type ApplicationConfiguration struct {
	...
	ClientCertificateAuthorities string                            `protobuf:"bytes,8,opt,name=client_certificate_authorities,json=clientCertificateAuthorities,proto3" json:"client_certificate_authorities,omitempty"`
...
const file_pkg_proto_configuration_bonanza_fetcher_bonanza_fetcher_proto_rawDesc = "" +
	"\n" +
	"=pkg/proto/configuration/bonanza_fetcher/bonanza_fetcher.proto\x12%bonanza.configuration.bonanza_fetcher\x1a3pkg/proto/configuration/filesystem/filesystem.proto\x1a+pkg/proto/configuration/global/global.proto\x1a'pkg/proto/configuration/grpc/grpc.proto\x1a'pkg/proto/configuration/http/http.proto\x1a1pkg/proto/configuration/model/parser/parser.proto\"\xb9\a\n" +
	...
	"\x15platform_private_keys\x18\a \x03(\tR\x13platformPrivateKeys\x12D\n" +
	"\x1eclient_certificate_authorities\x18\b \x01(\tR\x1cclientCertificateAuthorities\x12j\n" +
...
var file_pkg_proto_configuration_bonanza_fetcher_bonanza_fetcher_proto_depIdxs = []int32{
	...
	1, // 5: bonanza.configuration.bonanza_fetcher.ApplicationConfiguration.worker_id:type_name -> bonanza.configuration.bonanza_fetcher.ApplicationConfiguration.WorkerIdEntry
	6, // 6: bonanza.configuration.bonanza_fetcher.ApplicationConfiguration.parsed_object_pool:type_name -> bonanza.configuration.model.parser.ParsedObjectPool
